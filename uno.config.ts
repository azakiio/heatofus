...
export default defineConfig({
  ...
  shortcuts: [
    // you could still have object style
    {
      ...
      btn: "flex gap-2 items-center py-2 px-4 font-semibold rounded-lg shadow-md whitespace-nowrap transition-property-transform duration-[0.5s] bg-bg text-fg hover:-translate-y-1",
      "btn-outline":
